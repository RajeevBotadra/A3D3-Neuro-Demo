...
void XAlveo_hls4ml_Set_in1(XAlveo_hls4ml *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XAlveo_hls4ml_WriteReg(InstancePtr->Control_BaseAddress, XALVEO_HLS4ML_CONTROL_ADDR_IN1_DATA, (u32)(Data));
    XAlveo_hls4ml_WriteReg(InstancePtr->Control_BaseAddress, XALVEO_HLS4ML_CONTROL_ADDR_IN1_DATA + 4, (u32)(Data >> 32));
}

u64 XAlveo_hls4ml_Get_in1(XAlveo_hls4ml *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XAlveo_hls4ml_ReadReg(InstancePtr->Control_BaseAddress, XALVEO_HLS4ML_CONTROL_ADDR_IN1_DATA);
    Data += (u64)XAlveo_hls4ml_ReadReg(InstancePtr->Control_BaseAddress, XALVEO_HLS4ML_CONTROL_ADDR_IN1_DATA + 4) << 32;
    return Data;
}

void XAlveo_hls4ml_Set_in2(XAlveo_hls4ml *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XAlveo_hls4ml_WriteReg(InstancePtr->Control_BaseAddress, XALVEO_HLS4ML_CONTROL_ADDR_IN2_DATA, (u32)(Data));
    XAlveo_hls4ml_WriteReg(InstancePtr->Control_BaseAddress, XALVEO_HLS4ML_CONTROL_ADDR_IN2_DATA + 4, (u32)(Data >> 32));
}

u64 XAlveo_hls4ml_Get_in2(XAlveo_hls4ml *InstancePtr) {
    u64 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XAlveo_hls4ml_ReadReg(InstancePtr->Control_BaseAddress, XALVEO_HLS4ML_CONTROL_ADDR_IN2_DATA);
    Data += (u64)XAlveo_hls4ml_ReadReg(InstancePtr->Control_BaseAddress, XALVEO_HLS4ML_CONTROL_ADDR_IN2_DATA + 4) << 32;
    return Data;
}
