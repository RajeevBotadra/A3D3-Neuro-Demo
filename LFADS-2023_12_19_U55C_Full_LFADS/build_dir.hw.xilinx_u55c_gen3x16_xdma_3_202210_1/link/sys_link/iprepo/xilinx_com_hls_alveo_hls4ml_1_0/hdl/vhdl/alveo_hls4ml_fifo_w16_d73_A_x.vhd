...
entity alveo_hls4ml_fifo_w16_d73_A_x is
    generic (
...
architecture arch of alveo_hls4ml_fifo_w16_d73_A_x is

    -- component
    component alveo_hls4ml_fifo_w16_d73_A_x_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_alveo_hls4ml_fifo_w16_d73_A_x_ram : alveo_hls4ml_fifo_w16_d73_A_x_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity alveo_hls4ml_fifo_w16_d73_A_x_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 16;
        ADDR_WIDTH  : integer := 7;
...
architecture arch of alveo_hls4ml_fifo_w16_d73_A_x_ram is
