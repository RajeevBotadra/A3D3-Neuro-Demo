...
entity alveo_hls4ml_fifo_w16_d73_A is
    generic (
...
architecture arch of alveo_hls4ml_fifo_w16_d73_A is

    -- component
    component alveo_hls4ml_fifo_w16_d73_A_ram is
    generic (
        MEM_STYLE  : string  := "auto";
...
begin
----------------------- Instantiation -----------------------
    U_alveo_hls4ml_fifo_w16_d73_A_ram : alveo_hls4ml_fifo_w16_d73_A_ram
    generic map (
        MEM_STYLE  => MEM_STYLE,
...
entity alveo_hls4ml_fifo_w16_d73_A_ram is
    generic (
        MEM_STYLE   : string  := "auto";
        DATA_WIDTH  : integer := 16;
        ADDR_WIDTH  : integer := 7;
...
architecture arch of alveo_hls4ml_fifo_w16_d73_A_ram is
