...
// INCLUDE THIS RESOURCE UTILIZATION
    hls::stream<layer6_t> layer6_out[64];
    #pragma HLS STREAM variable=layer6_out depth=1
    nnet::dense<layer3_t, layer6_t, config6>(layer3_out, layer6_out, w6, b6); // dense_logvar
...
// INCLUDE THIS RESOURCE UTILIZATION
    ...
    nnet::sampling<layer8_t, layer11_t, config11>(layer8_out, layer11_out, normal); // standard_random_normal_5
...
// INCLUDE THIS RESOURCE UTILIZATION
    ...
    nnet::add<layer8_t, layer15_t, layer16_t, config16>(layer8_out, layer15_out, layer16_out); // add_5
...
// INCLUDE THIS RESOURCE UTILIZATION
    ...
    nnet::gru_stack<input17_t, layer18_t, layer19_t, config19>(decoder_input, layer18_out, layer19_out, w19, wr19, b19, br19); // DecoderGRU
